...
import 'package:flutter_application_1/Unit4/Coin17/coin17-page4.dart';
...
class Coin17Page3 extends StatelessWidget {
  const Coin17Page3({super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const Coin17Page4()),
        );
      },
      child: Scaffold(
