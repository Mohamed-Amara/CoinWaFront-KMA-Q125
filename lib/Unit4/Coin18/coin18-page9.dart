...
class Coin18Page9 extends StatelessWidget {
  const Coin18Page9({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const Coin18Page10()),
        );
      },
      child: Scaffold(
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Image.asset('assets/wawa_talking.png', width: imageSize),
                ],
              ),
              ExitButton(),
              const Row(
