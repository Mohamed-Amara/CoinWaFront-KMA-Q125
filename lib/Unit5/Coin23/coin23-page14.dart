...
import 'package:flutter_application_1/Unit5/Coin23/coin23-page15.dart';
...
class coin23Page14 extends StatelessWidget {
  const coin23Page14({super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => coin23Page15()),
        );
      },
      child: Scaffold(
            ...
            children: [
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    SpeechBubble(
                      'Good Question! Imagine investing \$100  by buying some shares ',
                    ),
                    Image.asset(
