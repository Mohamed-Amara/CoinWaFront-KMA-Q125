...
import 'package:flutter_application_1/Unit5/Coin23/coin23-page18.dart';
...
class coin23Page17 extends StatelessWidget {
  const coin23Page17({super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => coin23Page18()),
        );
      },
      child: Scaffold(
            ...
            children: [
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    SpeechBubble(
                      'When you want to, you can sell your stocks back into the market for their current value!',
                    ),
                    Image.asset(
