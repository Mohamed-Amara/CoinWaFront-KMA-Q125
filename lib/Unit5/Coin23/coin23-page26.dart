...
import 'package:flutter_application_1/Unit5/Coin23/coin23-page27.dart';
...
class coin23Page26 extends StatelessWidget {
  const coin23Page26({super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => coin23Page27()),
        );
      },
      child: Scaffold(
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                ...
                left: 20,
                right: 20,
                child: Image.asset('assets/Unit5/stock4.png',
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    SpeechBubble(
                      'Yes Invest! Your company is getting lots of attention! The stocks will go up!',
                    ),
                    Image.asset(
