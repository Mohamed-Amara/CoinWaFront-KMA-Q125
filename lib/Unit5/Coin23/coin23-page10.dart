...
import 'package:flutter_application_1/Unit5/Coin23/coin23-page11.dart';
...
class coin23Page10 extends StatelessWidget {
  const coin23Page10({super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => coin23Page11()),
        );
      },
      child: Scaffold(
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                ...
                left: 60,
                right: 60,
                child: Image.asset('assets/Unit5/count3.png',
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    SpeechBubble(
                      'Look Closely! The rocket is going to launch!',
                    ),
