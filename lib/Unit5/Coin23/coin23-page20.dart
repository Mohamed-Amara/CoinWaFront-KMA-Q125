...
import 'package:flutter_application_1/Unit5/Coin23/coin23-page21.dart';
...
class coin23Page20 extends StatelessWidget {
  const coin23Page20({super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => coin23Page21()),
        );
      },
      child: Scaffold(
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                ...
                left: 20,
                right: 20,
                child: Image.asset('assets/Unit5/stock1.png',
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    SpeechBubble(
                      'Lets track and predict your stock rocket investment!',
                    ),
                    Image.asset(
