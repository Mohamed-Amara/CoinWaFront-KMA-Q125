...
import 'package:flutter_application_1/Unit5/Coin23/coin23-page17.dart';
...
class coin23Page16 extends StatelessWidget {
  const coin23Page16({super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => coin23Page17()),
        );
      },
      child: Scaffold(
            ...
            children: [
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    SpeechBubble(
                      'If that company does poorly however, your stocks may be worth \$50 later! Their value decreases!',
                    ),
                    Image.asset(
