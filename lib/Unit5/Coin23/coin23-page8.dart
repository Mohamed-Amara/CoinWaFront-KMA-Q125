...
import 'package:flutter_application_1/Unit5/Coin23/coin23-page9.dart';
...
class coin23Page8 extends StatelessWidget {
  const coin23Page8({super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => coin23Page9()),
        );
      },
      child: Scaffold(
            ...
            children: [
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    SpeechBubble(
                      'Each seat is a share for someone to buy from the stock market ',
                    ),
