...
import 'package:flutter_application_1/Unit5/Coin23/coin23-page14.dart';
...
class coin23Page13 extends StatelessWidget {
  const coin23Page13({super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => coin23Page14()),
        );
      },
      child: Scaffold(
            ...
            children: [
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    SpeechBubble(
                      'How do I make money now that the rocket launched?',
                    ),
                    Image.asset(
