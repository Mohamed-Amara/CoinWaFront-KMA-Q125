...
import 'package:flutter_application_1/Unit5/Coin23/coin23-page13.dart';
    ...
    child: Stack(
      ...
      children: [
        Positioned(
          ...
          left: 60,
          child: Image.asset(
            'assets/Unit5/blue-triangle.png',
            width: 30,
          ),
        ),
        ConstrainedBox(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: const Color.fromARGB(255, 47, 1, 140), //rgb(47, 1, 140)
...
class coin23Page12 extends StatelessWidget {
  const coin23Page12({super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => coin23Page13()),
        );
      },
      child: Scaffold(
        ...
        body: SafeArea(
          child: Stack(
            children: [
              ...
              Positioned(
                bottom: 200,
                child: Image.asset('assets/Unit5/count1.png',
                    width: MediaQuery.of(context).size.width,
                    fit: BoxFit.contain),
              ),
