...
import 'package:flutter_application_1/Unit5/Coin23/coin23-page20.dart';
...
class coin23Page19 extends StatelessWidget {
  const coin23Page19({super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => coin23Page20()),
        );
      },
      child: Scaffold(
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                ...
                left: 20,
                right: 20,
                child: Image.asset('assets/Unit5/stock.png',
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    SpeechBubble(
                      'This is the Rocket map where we can see every stock rocket on the market live!',
                    ),
                    Image.asset(
