...
import 'package:flutter_application_1/Unit5/Coin23/coin23-page23.dart';
...
class coin23Page22 extends StatelessWidget {
  const coin23Page22({super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => coin23Page23()),
        );
      },
      child: Scaffold(
            ...
            children: [
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    SpeechBubble(
                      'Don’t Invest! People are worried and the stocks will go down!',
                    ),
                    Image.asset(
