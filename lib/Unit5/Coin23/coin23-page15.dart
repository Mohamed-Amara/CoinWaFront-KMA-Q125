...
import 'package:flutter_application_1/Unit5/Coin23/coin23-page16.dart';
...
class coin23Page15 extends StatelessWidget {
  const coin23Page15({super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => coin23Page16()),
        );
      },
      child: Scaffold(
            ...
            children: [
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    SpeechBubble(
                      'If that company does well, your stocks may be worth \$150 later! Their value increases!',
                    ),
                    Image.asset(
