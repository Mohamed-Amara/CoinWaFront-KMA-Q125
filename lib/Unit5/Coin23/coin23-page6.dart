...
import 'package:flutter_application_1/Unit5/Coin23/coin23-page7.dart';
...
class coin23Page6 extends StatelessWidget {
  const coin23Page6({super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => coin23Page7()),
        );
      },
      child: Scaffold(
            ...
            children: [
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    SpeechBubble(
                      'Now its time for the IPO! The first launch of this Stock!',
                    ),
