...
import 'package:flutter_application_1/Unit5/Coin23/coin23-page19.dart';
        ...
        ConstrainedBox(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: const Color.fromARGB(255, 122, 112, 219),
...
class coin23Page18 extends StatelessWidget {
  const coin23Page18({super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => coin23Page19()),
        );
      },
      child: Scaffold(
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                ...
                left: 50,
                right: 50,
                child: Image.asset('assets/Unit5/rocketscreen.png',
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    SpeechBubble(
                      'So you have to take a risk on that companys future!',
                    ),
                    Image.asset(
