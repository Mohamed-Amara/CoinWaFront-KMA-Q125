...
Widget SppeechBubble(String description) {
  return Stack(
    ...
    children: [
      Positioned(
        ...
        child: Transform.rotate(
          ...
          child: Image.asset('assets/trianglecut2.png', width: 35),
        ),
      ),
      Container(
        height: 100,
...
class investmentGrowth extends StatelessWidget{
  const investmentGrowth({super.key});
          ...
          children:[
            ...
            Row(
                ...
                children: [
                  ...
                  SppeechBubble(
                      'Think about your money as a tree seed'),
                ]),
            ...
            SizedBox(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => PlantInvest()),
                );
              },
