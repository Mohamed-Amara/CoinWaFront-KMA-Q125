...
class Coin6Quiz1 extends StatefulWidget {
  final bool isRepeat;
  const Coin6Quiz1({super.key, required this.isRepeat});

  @override
  State<Coin6Quiz1> createState() => _Coin6Quiz1State();
}

class _Coin6Quiz1State extends State<Coin6Quiz1> {
                    ...
                    child: Column(
                      children: [
                        Row(
                          ...
                          children: [
                            SpeechBubble(
                                "Recall: What does value refer to?", true)
                          ],
                        ),
                        Row(
                        ...
                        Expanded(
                          child: ListView(
                            children: [
                              ...
                              option("How much it costs to make something", false),
                              option("How important something is to you", false),
                              option("How much something is worth", true),
                            ],
                          ),
                        ),
                        Padding(
                                  ...
                                  onTap: () {
                                    ...
                                    if (widget.isRepeat) {
                                      navigateToNextQuestion(
                                          context, 6, "What are Assets?");
                                    } else {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) =>
                                              const Coin6Quiz2(isRepeat: false),
                                        ),
                                      );
                                    }
                                  },
